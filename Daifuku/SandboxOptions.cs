namespace Daifuku
{
    public abstract class BaseSandboxOptions
    {
        internal BaseSandboxOptions()
        {
        }
    ...
    public class AllowForms : BaseSandboxOptions
    {
        internal AllowForms()
        {
        }
    ...
    public class AllowModals : BaseSandboxOptions
    {
    ...
    public class AllowOrientationLock : BaseSandboxOptions
    {
    ...
    public class AllowPointerLock : BaseSandboxOptions
    {
    ...
    public class AllowPopups : BaseSandboxOptions
    {
    ...
    public class AllowPopupsToEscapeSandbox : BaseSandboxOptions
    {
    ...
    public class AllowPresentation : BaseSandboxOptions
    {
    ...
    public class AllowSameOrigin : BaseSandboxOptions
    {
    ...
    public class AllowScripts : BaseSandboxOptions
    {
    ...
    public class AllowTopNaviation : BaseSandboxOptions
    {
