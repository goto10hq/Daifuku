...
namespace Daifuku.Tests.Helpers
{
    ...
    {
        IDictionary<string, object> _validationAttributes;
        ...
        static IOptions<MvcViewOptions> GetOptions()
        {
        ...
        static IUrlHelperFactory CreateUrlHelperFactory(IUrlHelper urlHelper)
        {
